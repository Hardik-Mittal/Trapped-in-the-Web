...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        echo $username_err;
        header("refresh:10; url = http://localhost/login/register.php");
    }
...
<form action="" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="username" autocomplete="on" id="inputEmail4" placeholder="Username" required>
